    ...
    >
      ...
      {open && item.submenu && (
        <div className="absolute top-full left-0 pt-2 z-[9999] animate-in fade-in slide-in-from-top-1 duration-200">
          ...
          >
            <ul
              className={`${item.grid ? "grid grid-cols-2 gap-1" : "flex flex-col gap-1"}`}
            >
...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className={`max-w-7xl mx-auto px-4 flex items-center justify-between transition-colors duration-300 ${
